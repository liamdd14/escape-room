...
<p class="p1"><span class="Apple-converted-space">            </span>background: rgba(0, 255, 255, 0.2);</p>
<p class="p1"><span class="Apple-converted-space">            </span>border-color: rgba(0, 255, 255, 0.5);</p>
<p class="p1"><span class="Apple-converted-space">            </span>transform: translateY(-1px);</p>
<p class="p1"><span class="Apple-converted-space">        </span>}</p>
<p class="p2"><span class="Apple-converted-space">        </span></p>
<p class="p1"><span class="Apple-converted-space">        </span>.correct-answer {</p>
<p class="p1"><span class="Apple-converted-space">            </span>background: rgba(34, 197, 94, 0.3);</p>
<p class="p1"><span class="Apple-converted-space">            </span>border-color: rgba(34, 197, 94, 0.7);</p>
<p class="p1"><span class="Apple-converted-space">            </span>animation: pulse-green 1s ease-in-out;</p>
<p class="p1"><span class="Apple-converted-space">        </span>}</p>
<p class="p2"><span class="Apple-converted-space">        </span></p>
<p class="p1"><span class="Apple-converted-space">        </span>.wrong-answer {</p>
<p class="p1"><span class="Apple-converted-space">            </span>background: rgba(239, 68, 68, 0.3);</p>
<p class="p1"><span class="Apple-converted-space">            </span>border-color: rgba(239, 68, 68, 0.7);</p>
<p class="p1"><span class="Apple-converted-space">            </span>animation: shake 0.5s ease-in-out;</p>
<p class="p1"><span class="Apple-converted-space">        </span>}</p>
<p class="p2"><span class="Apple-converted-space">        </span></p>
<p class="p1"><span class="Apple-converted-space">        </span>@keyframes pulse-green {</p>
<p class="p1"><span class="Apple-converted-space">            </span>0%, 100% { box-shadow: 0 0 0 0 rgba(34, 197, 94, 0.7); }</p>
<p class="p1"><span class="Apple-converted-space">            </span>50% { box-shadow: 0 0 0 10px rgba(34, 197, 94, 0); }</p>
<p class="p1"><span class="Apple-converted-space">        </span>}</p>
<p class="p2"><span class="Apple-converted-space">        </span></p>
...
<p class="p1"><span class="Apple-converted-space">            </span>25% { transform: translateX(-5px); }</p>
<p class="p1"><span class="Apple-converted-space">            </span>75% { transform: translateX(5px); }</p>
<p class="p1"><span class="Apple-converted-space">        </span>}</p>
<p class="p2"><span class="Apple-converted-space">        </span></p>
<p class="p1"><span class="Apple-converted-space">        </span>.progress-orb {</p>
...
<p class="p1"><span class="Apple-converted-space">            </span>border: 2px solid rgba(255, 255, 255, 0.3);</p>
<p class="p1"><span class="Apple-converted-space">            </span>transition: all 0.3s ease;</p>
<p class="p1"><span class="Apple-converted-space">        </span>}</p>
<p class="p2"><span class="Apple-converted-space">        </span></p>
...
<p class="p1"><span class="Apple-converted-space">   </span>&lt;div class="absolute top-20 right-20 w-1 h-1 bg-green-400 rounded-full animate-pulse"&gt;&lt;/div&gt;</p>
...
<p class="p1"><span class="Apple-converted-space">                    </span>&lt;text x="78" y="12" font-size="6" fill="#FF0000"&gt;UP&lt;/text&gt;</p>
<p class="p1"><span class="Apple-converted-space">                </span>&lt;/svg&gt;`</p>
<p class="p1"><span class="Apple-converted-space">            </span>},</p>
<p class="p1"><span class="Apple-converted-space">            </span>{</p>
...
<p class="p1"><span class="Apple-converted-space">                    </span>&lt;line x1="80" y1="62" x2="80" y2="70" stroke="#808080" stroke-width="3"/&gt;</p>
<p class="p1"><span class="Apple-converted-space">                </span>&lt;/svg&gt;`</p>
<p class="p1"><span class="Apple-converted-space">            </span>},</p>
<p class="p1"><span class="Apple-converted-space">            </span>{</p>
...
<p class="p1"><span class="Apple-converted-space">                </span>image: `&lt;svg width="100" height="80" viewBox="0 0 100 80"&gt;</p>
<p class="p1"><span class="Apple-converted-space">                    </span>&lt;rect x="25" y="8" width="50" height="55" fill="#C0C0C0" stroke="#808080" stroke-width="3" stroke-dasharray="4,4"/&gt;</p>
<p class="p1"><span class="Apple-converted-space">                    </span>&lt;circle cx="50" cy="25" r="6" fill="#FFB6C1"/&gt;</p>
<p class="p1"><span class="Apple-converted-space">                    </span>&lt;rect x="47" y="31" width="6" height="12" fill="#4169E1"/&gt;</p>
...
<p class="p1"><span class="Apple-converted-space">                    </span>&lt;circle cx="57" cy="45" r="4" fill="#FFFF00"/&gt;</p>
...
<p class="p1"><span class="Apple-converted-space">            </span>const explanationText = document.getElementById('explanation-text');</p>
<p class="p2"><br></p>
...
<p class="p1"><span class="Apple-converted-space">            </span>}</p>
<p class="p2"><br></p>
<p class="p1"><span class="Apple-converted-space">            </span>explanationText.textContent = puzzle.explanation;</p>
<p class="p1"><span class="Apple-converted-space">            </span>explanationText.className = 'text-lg text-cyan-100';</p>
<p class="p1"><span class="Apple-converted-space">            </span>feedbackDiv.classList.remove('hidden');</p>
<p class="p1"><span class="Apple-converted-space">        </span>}</p>
<p class="p2"><br></p>
<p class="p1"><span class="Apple-converted-space">        </span>function showEscapeSuccess() {</p>
<p class="p1"><span class="Apple-converted-space">            </span>document.getElementById('current-puzzle').style.display = 'none';</p>
<p class="p1"><span class="Apple-converted-space">            </span>document.querySelector('.mb-8').style.display = 'none'; // Hide progress tracker</p>
<p class="p1"><span class="Apple-converted-space">            </span>document.getElementById('escape-success').classList.remove('hidden');</p>
<p class="p1"><span class="Apple-converted-space">        </span>}</p>
<p class="p2"><br></p>
<p class="p1"><span class="Apple-converted-space">        </span>function restartEscapeRoom() {</p>
<p class="p1"><span class="Apple-converted-space">            </span>currentPuzzleIndex = 0;</p>
<p class="p1"><span class="Apple-converted-space">            </span>solvedPuzzles.clear();</p>
<p class="p2"><span class="Apple-converted-space">            </span></p>
<p class="p1"><span class="Apple-converted-space">            </span>document.getElementById('escape-success').classList.add('hidden');</p>
<p class="p1"><span class="Apple-converted-space">            </span>document.getElementById('current-puzzle').style.display = 'block';</p>
<p class="p1"><span class="Apple-converted-space">            </span>document.querySelector('.mb-8').style.display = 'block';</p>
<p class="p2"><span class="Apple-converted-space">            </span></p>
<p class="p1"><span class="Apple-converted-space">            </span>initializeProgressOrbs();</p>
<p class="p1"><span class="Apple-converted-space">            </span>updateProgressOrbs();</p>
<p class="p1"><span class="Apple-converted-space">            </span>renderCurrentPuzzle();</p>
<p class="p1"><span class="Apple-converted-space">        </span>}</p>
<p class="p2"><br></p>
<p class="p1"><span class="Apple-converted-space">        </span>async function onConfigChange(config) {</p>
<p class="p1"><span class="Apple-converted-space">            </span>const titleElement = document.getElementById('room-title');</p>
<p class="p1"><span class="Apple-converted-space">            </span>const storyElement = document.getElementById('story-intro');</p>
<p class="p2"><span class="Apple-converted-space">            </span></p>
<p class="p1"><span class="Apple-converted-space">            </span>if (titleElement) {</p>
<p class="p1"><span class="Apple-converted-space">                </span>titleElement.textContent = config.room_title || defaultConfig.room_title;</p>
<p class="p1"><span class="Apple-converted-space">            </span>}</p>
<p class="p1"><span class="Apple-converted-space">            </span>if (storyElement) {</p>
<p class="p1"><span class="Apple-converted-space">                </span>storyElement.textContent = config.story_intro || defaultConfig.story_intro;</p>
<p class="p1"><span class="Apple-converted-space">            </span>}</p>
<p class="p1"><span class="Apple-converted-space">        </span>}</p>
<p class="p2"><br></p>
...
<p class="p1"><span class="Apple-converted-space">            </span>renderCurrentPuzzle();</p>
<p class="p2"><span class="Apple-converted-space">            </span></p>
<p class="p1"><span class="Apple-converted-space">            </span>document.getElementById('restart-btn').addEventListener('click', restartEscapeRoom);</p>
<p class="p2"><span class="Apple-converted-space">            </span></p>
...
<p class="p1"><span class="Apple-converted-space">                    </span>defaultConfig: defaultConfig,</p>
